...
<form class="box"  method="post">
 ...
 <%
  try {
      ...
      PreparedStatement ps=con.prepareStatement("select AdminUser_id from Admin_User1 where AdminUser_id=? and password=?");
      ps.setString(1, n);
      ps.setString(2, p);
      ...
      int count=0;
      if(rs.next()){
          RequestDispatcher rd=request.getRequestDispatcher("Adminwebsite.jsp");
