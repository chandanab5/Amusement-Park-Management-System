      ...
      <ul>
        ...
        <li><a href="#">Booking<i class="fas fa-caret-down"></i></a>
            ...
            <div class="dropdown-menu">
                <ul>
                  <li><a href="bookedticket.jsp">Ticket Bookings</a></li>
                  
                  <li>
                    <a href="#">Staff Details<i class="fas fa-caret-right"></i></a>
                    
                    <div class="dropdown-menu-1">
                      <ul>
                        <li><a href="Staff.jsp">Accounting Staff</a></li>
                        <li><a href="Staff.jsp">Maintenance Staff</a></li>
                        <li><a href="Staff.jsp">Performers Staff</a></li>
